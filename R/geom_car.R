...
#' geom_car constructs a new layer for ggplot2 layer via the GeomWick for geom argument
#'
...
#'
#' @export
geom_car <- function(mapping     = NULL,
                     data        = NULL,
                     stat        = "identity",
                     position    = "identity",
                     ...,
...
#' GeomCar define the new geom
#' @export
GeomCar <- ggplot2::ggproto(
  "GeomCar", ggplot2::Geom,
  required_aes = c("x", "y"),
  ...
  default_aes = ggplot2::aes(
    ...
    alpha  = NA,
    stroke = 0.5,
    image_filename  = system.file("car.png", package = "geomwick", mustWork = TRUE),
    scale = 5
  ),
